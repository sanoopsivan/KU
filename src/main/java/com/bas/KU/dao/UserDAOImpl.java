...
public class UserDAOImpl implements UserDAO {
	...
	private static final String UPDATE_USER_QUERY = "UPDATE user set firstName = ?,lastName = ?, gender = ?, email = ? ,address = ?,phoneNumber =?,landlineNumber =?,areaCode =?,status =? where user_id = ?";
